...
email =df_helper.get_string(parameter_name="email", parameter_display_name="Enter Emails", parameter_description="Enter the emails to get the report",default_value="")
file_paths = []
